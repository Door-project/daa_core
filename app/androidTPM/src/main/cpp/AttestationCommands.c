...
TPM2_Certify(
    ...
    // by SignAttestInfo()
    printf("Using key: ");
    for(int i = 0; i < signObject->publicArea.unique.rsa.t.size; i++){
        printf("%02x ", signObject->publicArea.unique.rsa.t.buffer[i]);
    }
    printf("\n");
